(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, r) => {
    ...
    let n = e.r(47441).createRenderSearchParamsFromClient;
    ("function" == typeof r.default ||
      ("object" == typeof r.default && null !== r.default)) &&
      void 0 === r.default.__esModule &&
      (Object.defineProperty(r.default, "__esModule", { value: !0 }),
  ...
  (e, t, r) => {
    ...
    let n = e.r(43931).createRenderParamsFromClient;
    ("function" == typeof r.default ||
      ("object" == typeof r.default && null !== r.default)) &&
      void 0 === r.default.__esModule &&
      (Object.defineProperty(r.default, "__esModule", { value: !0 }),
  ...
  (e, t, r) => {
    ...
    let n = (0, e.r(90735).createAsyncLocalStorage)();
  },
  43404,
  (e, t, r) => {
    "use strict";
  ...
  (e, t, r) => {
        ...
        switch (n.type) {
          ...
          case "validation-client":
            return (function (t, r, n) {
              var a;
              let { createExhaustiveSearchParamsProxy: o } = e.r(34057);
    ...
    function v(t, r, n, a) {
      ...
      if (n.validationSamples) {
        let { createExhaustiveSearchParamsProxy: a } = e.r(34057),
  ...
  (e, t, r) => {
          ...
          case "request":
            if (s.asyncApiPromises && s.validationSamples)
              return (function (t, r, n, a, o) {
                let { createExhaustiveParamsProxy: i } = e.r(34057),
    ...
    function R(t, r, n) {
      let { createExhaustiveParamsProxy: a } = e.r(34057);
      return Promise.resolve(
        a(
          t,
  ...
  (e, t, r) => {
    ...
    function l({ Component: t, serverProvidedParams: r }) {
      ...
      if ("u" < typeof window) {
        let r,
          a,
          { createSearchParamsFromClient: o } = e.r(93611);
        r = o(c);
        let { createParamsFromClient: i } = e.r(55976);
        return (a = i(u)), (0, n.jsx)(t, { params: a, searchParams: r });
      }
      {
        let { createRenderSearchParamsFromClient: r } = e.r(59889),
          a = r(c),
          { createRenderParamsFromClient: o } = e.r(60191),
          i = o(u);
  ...
  (e, t, r) => {
    ...
    function i({ Component: t, slots: r, serverProvidedParams: s }) {
      ...
      if ("u" < typeof window) {
        let { createParamsFromClient: a } = e.r(55976),
          o = a(l);
        return (0, n.jsx)(t, { ...r, params: o });
      }
      {
        let { createRenderParamsFromClient: a } = e.r(60191),
          o = a(l);
        return (0, n.jsx)(t, { ...r, params: o });
      }
    }
