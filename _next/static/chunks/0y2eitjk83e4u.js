(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
    ...
    function $(e, t, r, n, a) {
      ...
      switch (l.status) {
        ...
        default:
          return (
            I
              ? ((I.errored = !0), (I.value = null), (I.reason = l.reason))
              : (I = {
                  parent: null,
                  chunk: null,
                  value: null,
  ...
  (e, t, r) => {
    ...
    function E(t) {
      ...
      {
        let { createPrefetchURL: r } = e.r(80011);
        try {
          return r(t);
        } catch {
          return (
    ...
    function T(t, r) {
      if ("u" > typeof window) {
        ...
        let { getCurrentAppRouterState: a } = e.r(56513),
          l = a();
        if (null !== l) {
          let e = l.tree;
          if (null === n) {
    ...
    async function e_(e, t, r, n, a) {
      ...
      try {
        ...
        let [P, T] = await Promise.all([
          ...
          D = l.headers.get(O.NEXT_NAV_DEPLOYMENT_ID_HEADER) ?? P.b,
          M = (0, _.normalizeFlightData)(P.f);
        if ("string" == typeof M) return eg(a, Date.now() + 1e4), null;
        let I = (0, b.convertServerPatchToFullTree)(
          N,
          n,
          M,
          i,
  ...
  (e, t, r) => {
    ...
    async function m(e, t, r, n, a, f, p, h, y, _, g) {
      ...
      if (null !== U) {
        ...
        null !== D &&
          (0, c.processRuntimePrefetchStream)(e, D, h, A)
            .then((t) => {
              null !== t &&
  ...
  (e, t, r) => {
    ...
    let l = e.r(85051),
      u = e.r(70133),
      i = "u" < typeof window ? e.r(55542).actionAsyncStorage : void 0;
